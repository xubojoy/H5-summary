...
<div id="main" class="bg_f4" style="-webkit-overflow-scrolling : touch;">
	...
	<nav class="navigate bg_white" style="display:none" >
		<ul>
			<li class="font_gray dateTime"  onclick="MyOrders.orderNavSearch('dateTime',this)">
				<span style="margin-right:5px;">日期</span><img src="<c:url value="/images/icon_down.png" />" /> 
			</li>
			<li class="font_dark_brown orderType" >
				<span style="margin-right:5px;">预约特需</span><img src="<c:url value="/images/icon_down_deep.png" />" /> 
			</li>
		</ul>
	</nav>
	<ul class="seacherTypeSelect bg_white " style="display:none"></ul>
	<ul class="ordersNav font15 font_dark_gray bg_white">
		<li style="width:20%"><span class="selected" onclick="MyOrders.statusSearch(null,this)">全部</span></li>
		<li style="width:20%"><span onclick="MyOrders.statusSearch('waitingConfirm',this)">待确认</span></li>
		<li style="width:20%"><span onclick="MyOrders.statusSearch('confirmed',this)">已沟通</span></li>
		<li style="width:20%"><span onclick="MyOrders.statusSearch('confirmed',this)">已取消</span></li>
		<li style="width:20%"><span onclick="MyOrders.statusSearch('completed',this)">已完成</span></li>
	</ul>
